...
public interface IConversationRepository
{
    ...
    Task<bool> DeleteConversationAsync(Conversations entity, CancellationToken cancellationToken);
    ...
    Task<(bool isMember, DateTimeOffset HistoryClearedAt)> IsMemberInConversationAsync(Guid conversationId, Guid userId, CancellationToken cancellationToken);
}